...
pub static OPCODE_TABLE_0F38: [Option<OpcodeEntry>; 256] = {
    ...
    // 0x00: PSHUFB
    table[0x00] = Some(OpcodeEntry::new(
        "pshufb",
        Operation::Other(0x38_00),
    ...
    table[0x01] = Some(OpcodeEntry::new(
        "phaddw",
        Operation::Other(0x38_01),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x02: PHADDD
    table[0x02] = Some(OpcodeEntry::new(
        "phaddd",
        Operation::Other(0x38_02),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x03] = Some(OpcodeEntry::new(
        "phaddsw",
        Operation::Other(0x38_03),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x04: PMADDUBSW
    table[0x04] = Some(OpcodeEntry::new(
        "pmaddubsw",
        Operation::Other(0x38_04),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x05] = Some(OpcodeEntry::new(
        "phsubw",
        Operation::Other(0x38_05),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x06: PHSUBD
    table[0x06] = Some(OpcodeEntry::new(
        "phsubd",
        Operation::Other(0x38_06),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x07: PHSUBSW
    table[0x07] = Some(OpcodeEntry::new(
        "phsubsw",
        Operation::Other(0x38_07),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x09] = Some(OpcodeEntry::new(
        "psignw",
        Operation::Other(0x38_09),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x0A: PSIGND
    table[0x0A] = Some(OpcodeEntry::new(
        "psignd",
        Operation::Other(0x38_0A),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x17] = Some(OpcodeEntry::new(
        "ptest",
        Operation::Other(0x38_17),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x1C: PABSB
    table[0x1C] = Some(OpcodeEntry::new(
        "pabsb",
        Operation::Other(0x38_1C),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x1E] = Some(OpcodeEntry::new(
        "pabsd",
        Operation::Other(0x38_1E),
        OperandEncoding::ModRmReg_Rm,
    ));

    // SSE4.1 packed extend instructions
    // 0x20: PMOVSXBW
    table[0x20] = Some(OpcodeEntry::new(
        "pmovsxbw",
        Operation::Other(0x38_20),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x21] = Some(OpcodeEntry::new(
        "pmovsxbd",
        Operation::Other(0x38_21),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x22: PMOVSXBQ
    table[0x22] = Some(OpcodeEntry::new(
        "pmovsxbq",
        Operation::Other(0x38_22),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x23] = Some(OpcodeEntry::new(
        "pmovsxwd",
        Operation::Other(0x38_23),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x24: PMOVSXWQ
    table[0x24] = Some(OpcodeEntry::new(
        "pmovsxwq",
        Operation::Other(0x38_24),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x25] = Some(OpcodeEntry::new(
        "pmovsxdq",
        Operation::Other(0x38_25),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x28: PMULDQ
    table[0x28] = Some(OpcodeEntry::new(
        "pmuldq",
        Operation::Other(0x38_28),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x29] = Some(OpcodeEntry::new(
        "pcmpeqq",
        Operation::Other(0x38_29),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x2A: MOVNTDQA
    table[0x2A] = Some(OpcodeEntry::new(
        "movntdqa",
        Operation::Other(0x38_2A),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x33] = Some(OpcodeEntry::new(
        "pmovzxwd",
        Operation::Other(0x38_33),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x34: PMOVZXWQ
    table[0x34] = Some(OpcodeEntry::new(
        "pmovzxwq",
        Operation::Other(0x38_34),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x35] = Some(OpcodeEntry::new(
        "pmovzxdq",
        Operation::Other(0x38_35),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x37: PCMPGTQ
    table[0x37] = Some(OpcodeEntry::new(
        "pcmpgtq",
        Operation::Other(0x38_37),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x38: PMINSB
    table[0x38] = Some(OpcodeEntry::new(
        "pminsb",
        Operation::Other(0x38_38),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x39] = Some(OpcodeEntry::new(
        "pminsd",
        Operation::Other(0x38_39),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x3A: PMINUW
    table[0x3A] = Some(OpcodeEntry::new(
        "pminuw",
        Operation::Other(0x38_3A),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x3B] = Some(OpcodeEntry::new(
        "pminud",
        Operation::Other(0x38_3B),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x3C: PMAXSB
    table[0x3C] = Some(OpcodeEntry::new(
        "pmaxsb",
        Operation::Other(0x38_3C),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x3D] = Some(OpcodeEntry::new(
        "pmaxsd",
        Operation::Other(0x38_3D),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x3E: PMAXUW
    table[0x3E] = Some(OpcodeEntry::new(
        "pmaxuw",
        Operation::Other(0x38_3E),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x3F: PMAXUD
    table[0x3F] = Some(OpcodeEntry::new(
        "pmaxud",
        Operation::Other(0x38_3F),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x41] = Some(OpcodeEntry::new(
        "phminposuw",
        Operation::Other(0x38_41),
        OperandEncoding::ModRmReg_Rm,
    ));

    // AVX instructions
    // 0x0C: VPERMILPS (VEX.NDS.128/256.66.0F38.W0)
    table[0x0C] = Some(OpcodeEntry::new(
        "permilps",
        Operation::Other(0x38_0C),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x0D] = Some(OpcodeEntry::new(
        "permilpd",
        Operation::Other(0x38_0D),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x0E: VTESTPS (VEX.128/256.66.0F38.W0)
    table[0x0E] = Some(OpcodeEntry::new(
        "testps",
        Operation::Test,
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x0F] = Some(OpcodeEntry::new(
        "testpd",
        Operation::Test,
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x16] = Some(OpcodeEntry::new(
        "permps",
        Operation::Other(0x3816),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x18: VBROADCASTSS (VEX.128/256.66.0F38.W0)
    table[0x18] = Some(OpcodeEntry::new(
        "broadcastss",
        Operation::Other(0x38_18),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x19] = Some(OpcodeEntry::new(
        "broadcastsd",
        Operation::Other(0x38_19),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x1A: VBROADCASTF128 (VEX.256.66.0F38.W0)
    table[0x1A] = Some(OpcodeEntry::new(
        "broadcastf128",
        Operation::Other(0x38_1A),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x2C: VMASKMOVPS (VEX.NDS.128/256.66.0F38.W0) - load form
    table[0x2C] = Some(OpcodeEntry::new(
        "maskmovps",
        Operation::Load,
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x2E] = Some(OpcodeEntry::new(
        "maskmovps",
        Operation::Store,
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x2F] = Some(OpcodeEntry::new(
        "maskmovpd",
        Operation::Store,
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x36] = Some(OpcodeEntry::new(
        "permd",
        Operation::Other(0x38_36),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x58] = Some(OpcodeEntry::new(
        "pbroadcastd",
        Operation::Other(0x38_58),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x59: VPBROADCASTQ (VEX.128/256.66.0F38.W0)
    table[0x59] = Some(OpcodeEntry::new(
        "pbroadcastq",
        Operation::Other(0x38_59),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x5A: VBROADCASTI128 (VEX.256.66.0F38.W0)
    table[0x5A] = Some(OpcodeEntry::new(
        "broadcasti128",
        Operation::Other(0x38_5A),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x91] = Some(OpcodeEntry::new(
        "pgatherqd",
        Operation::Load,
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x92] = Some(OpcodeEntry::new(
        "gatherdps",
        Operation::Load,
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x93] = Some(OpcodeEntry::new(
        "gatherqps",
        Operation::Load,
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0xCD] = Some(OpcodeEntry::new(
        "sha256msg2",
        Operation::Other(0x38_CD),
        OperandEncoding::ModRmReg_Rm,
    ));

    // CRC32 instructions (need F2 prefix)
    // 0xF0: CRC32 r32, r/m8
    table[0xF0] = Some(OpcodeEntry::new(
        "crc32",
        Operation::Other(0x38_F0),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0xF1: CRC32 r32, r/m16/32/64
    table[0xF1] = Some(OpcodeEntry::new(
        "crc32",
        Operation::Other(0x38_F1),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0x98] = Some(OpcodeEntry::new(
        "vfmadd132ps",
        Operation::Other(0x38_98),
        OperandEncoding::ModRmReg_Rm,
    ));

    // VFMADD213PS/PD (0xA8)
    table[0xA8] = Some(OpcodeEntry::new(
        "vfmadd213ps",
        Operation::Other(0x38_A8),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0xB9] = Some(OpcodeEntry::new(
        "vfmadd231ss",
        Operation::Other(0x38_B9),
        OperandEncoding::ModRmReg_Rm,
    ));

    // VFMSUB132PS/PD (0x9A)
    table[0x9A] = Some(OpcodeEntry::new(
        "vfmsub132ps",
        Operation::Other(0x38_9A),
        OperandEncoding::ModRmReg_Rm,
    ));

    // VFMSUB213PS/PD (0xAA)
    table[0xAA] = Some(OpcodeEntry::new(
        "vfmsub213ps",
        Operation::Other(0x38_AA),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0xBA] = Some(OpcodeEntry::new(
        "vfmsub231ps",
        Operation::Other(0x38_BA),
        OperandEncoding::ModRmReg_Rm,
    ));

    // VFNMADD132PS/PD (0x9C)
    table[0x9C] = Some(OpcodeEntry::new(
        "vfnmadd132ps",
        Operation::Other(0x38_9C),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0xBC] = Some(OpcodeEntry::new(
        "vfnmadd231ps",
        Operation::Other(0x38_BC),
        OperandEncoding::ModRmReg_Rm,
    ));

    // VFNMSUB132PS/PD (0x9E)
    table[0x9E] = Some(OpcodeEntry::new(
        "vfnmsub132ps",
        Operation::Other(0x38_9E),
        OperandEncoding::ModRmReg_Rm,
    ));

    // VFNMSUB213PS/PD (0xAE)
    table[0xAE] = Some(OpcodeEntry::new(
        "vfnmsub213ps",
        Operation::Other(0x38_AE),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0xBE] = Some(OpcodeEntry::new(
        "vfnmsub231ps",
        Operation::Other(0x38_BE),
        OperandEncoding::ModRmReg_Rm,
    ));

    // AES-NI instructions
    // 0xDB: AESIMC
    table[0xDB] = Some(OpcodeEntry::new(
        "aesimc",
        Operation::Other(0x38_DB),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0xDC: AESENC
    table[0xDC] = Some(OpcodeEntry::new(
        "aesenc",
        Operation::Other(0x38_DC),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0xDD: AESENCLAST
    table[0xDD] = Some(OpcodeEntry::new(
        "aesenclast",
        Operation::Other(0x38_DD),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0xDE: AESDEC
    table[0xDE] = Some(OpcodeEntry::new(
        "aesdec",
        Operation::Other(0x38_DE),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0xDF: AESDECLAST
    table[0xDF] = Some(OpcodeEntry::new(
        "aesdeclast",
        Operation::Other(0x38_DF),
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0xF2] = Some(OpcodeEntry::new(
        "andn",
        Operation::AndNot,
        OperandEncoding::ModRmReg_Rm,
    ));
    ...
    table[0xF3] = Some(OpcodeEntry::new(
        "bmi1_group",
        Operation::Other(0x38_F3),
    ...
    table[0xF5] = Some(OpcodeEntry::new(
        "bzhi",
    ...
    table[0xF6] = Some(OpcodeEntry::new(
        "mulx",
    ...
    table[0xF7] = Some(OpcodeEntry::new(
        "bextr",
...
#[allow(dead_code)]
pub fn cet_shadow_stack_info(
    opcode: u8,
    has_66_prefix: bool,
) -> Option<(&'static str, Operation, bool)> {
