...
pub static OPCODE_TABLE_0F3A: [Option<OpcodeEntry>; 256] = {
    ...
    table[0x44] = Some(OpcodeEntry::new(
        "pclmulqdq",
        Operation::Other(0x3A_44),
        OperandEncoding::ModRmReg_Rm,
    ));

    // SSE4.2 string instructions
    // 0x60: PCMPESTRM
    table[0x60] = Some(OpcodeEntry::new(
        "pcmpestrm",
        Operation::Other(0x3A_60),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x61: PCMPESTRI
    table[0x61] = Some(OpcodeEntry::new(
        "pcmpestri",
        Operation::Other(0x3A_61),
        OperandEncoding::ModRmReg_Rm,
    ));

    // 0x62: PCMPISTRM
    table[0x62] = Some(OpcodeEntry::new(
        "pcmpistrm",
        Operation::Other(0x3A_62),
        OperandEncoding::ModRmReg_Rm,
    ));
